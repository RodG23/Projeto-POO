...
public class Main {
    ...
    public static void main(String[] args)
    {
        ...
        Artigo a = new Artigo(Artigo.Cond.NOVO, Artigo.St.BOM, 0, trans, "coisa", "nike", 20, 23);
        Artigo b = a.clone();
        ...
        // u1.aVenda_Artigo(vinted, a1, t);
        // u1.aVenda_Artigo(vinted, a2, t2);

        // //perfil do utilizador u2 tem um tshirt à venda
        // u2.aVenda_Artigo(vinted, a3, t);
