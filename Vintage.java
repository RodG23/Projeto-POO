...
public class Vintage {
    ...
    public Vintage(Map<Integer, Artigo> stock, Map<Integer, Set<Encomenda>> encomendas, Map<Integer, Set<Artigo>> vendas, Map<String, String> creds, double totalAuferido, double taxaGSNovo, double taxaGSUsado) {
